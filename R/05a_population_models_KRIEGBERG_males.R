...
fwrite(summary,"data/population_models/models_summary_kriegberg_male.csv")
writexl::write_xlsx(summary,"data/population_models/models_summary_kriegberg_male.xlsx")
