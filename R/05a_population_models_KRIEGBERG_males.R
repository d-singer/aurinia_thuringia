...
falter_complete <- falter_complete %>% filter(site == "krb" & sex == "male")
...
fwrite(model.table, "data/population_models/models_output_kriegberg_male.csv")
writexl::write_xlsx(model.table,"data/population_models/models_output_kriegberg_male.xlsx")
...
fwrite(summary %>% select(!weightcum),"data/population_models/models_summary_kriegberg_male.csv")
writexl::write_xlsx(summary %>% select(!weightcum),"data/population_models/models_summary_kriegberg_male.xlsx")
writexl::write_xlsx(summary %>% filter(weightcum <= 0.95) %>% select(!weightcum),"data/population_models/models_summary_kriegberg_male_weight95.xlsx")
...
bestmod <- fread("data/population_models/models_summary_kriegberg.csv")
...
data.table::fwrite(df, "data/kriegberg_daily_estimates_males.csv")
