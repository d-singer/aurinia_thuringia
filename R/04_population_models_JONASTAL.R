...
falter_complete <- falter_complete %>% filter(site == "jon")
...
writexl::write_xlsx(model.table,"data/models_output_jonastal.xlsx")
...
writexl::write_xlsx(summary,"data/models_summary_jonastal.xlsx")
