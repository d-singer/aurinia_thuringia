...
fwrite(summary,"data/population_models/models_summary_hainich_male.csv")
writexl::write_xlsx(summary,"data/population_models/models_summary_hainich_male.xlsx")
